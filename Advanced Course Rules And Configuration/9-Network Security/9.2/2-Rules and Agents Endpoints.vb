...
<group name="HoneypotServers">
  <rule id="100000" level="3">
    <if_sid>86601</if_sid>
    <hostname>eventualatex</hostname>
...
<group name="HoneypotAlerts">
  ...
  <!-- Honeypot Suricata Alert Severity 3 -->
  ...
  <!-- Honeypot Suricata Alert Severity 2 -->
  ...
  <!-- Honeypot Suricata Alert Severity 1 -->
...
AGENT ENDPOINTS OF TPOT:

<localfile>
  <log_format>json</log_format>
  <location>/home/ubuntu/tpotce/data/cowrie/log/cowrie.json</location>
</localfile>

<localfile>
  <log_format>json</log_format>
  <location>/home/ubuntu/tpotce/data/cowrie/log/cowrie/data/suricata/log/eve.json</location>
</localfile>
