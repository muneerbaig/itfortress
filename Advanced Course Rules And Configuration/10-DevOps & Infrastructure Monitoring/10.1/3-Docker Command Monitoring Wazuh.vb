Docker Command Monitoring Wazuh



Add these rules in Wazuh-dashboard Endpoints;

nano /var/ossec/etc/rules/local-rules    
...
<!--
  ...
  -  2025-12-31 Renamed docker.status to docker.Action and added the overwrite tag.
-->
...
<group name="docker,">
     ...
     <rule id="87901" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87902" level="5" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87907" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87908" level="5" overwrite="yes">
        <if_sid>87907</if_sid>
        <field name="docker.Action">^exec_start: bash $|^exec_start: /bin/bash $|^exec_start: sh $|^exec_start: dash $|^exec_start: /bin/dash $</field>
    ...
    <rule id="87909" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87910" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87911" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87917" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87918" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^tag$</field>
        <description>Docker: Image $(docker.Actor.Attributes.name) tagged</description>
        <options>no_full_log</options>
    </rule>

    <rule id="87919" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^untag$</field>
        <description>Docker: Image $(docker.Actor.Attributes.name) untagged</description>
        <options>no_full_log</options>
    </rule>

    <rule id="87920" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^import$</field>
        <description>Docker: Image created from imported data</description>
        <group>pci_dss_10.2.7,gdpr_IV_32.2,hipaa_164.312.b,nist_800_53_AU.14,tsc_CC6.8,tsc_CC7.2,tsc_CC7.3,</group>
        <options>no_full_log</options>
    </rule>

    <rule id="87921" level="7" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87922" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87923" level="5" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87924" level="7" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^kill$|^die$</field>
        <description>Docker: Container $(docker.Actor.Attributes.name) received the action: $(docker.status)</description>
        <group>gdpr_IV_32.2,</group>
        <options>no_full_log</options>
    </rule>

    <rule id="87925" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87926" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^top$</field>
        <description>Docker: Running processes of container $(docker.Actor.Attributes.name) displayed</description>
        <options>no_full_log</options>
    </rule>

    <rule id="87932" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87933" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^load$</field>
        <description>Docker: Image loaded</description>
        <options>no_full_log</options>
    </rule>

    <rule id="87934" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^save$</field>
        <description>Docker: Image saved</description>
        <options>no_full_log</options>
    </rule>

    <rule id="87935" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
    ...
    <rule id="87952" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^resize$</field>
    ...
    <rule id="87953" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
        <field name="docker.Action">^checkpoint$</field>
        <description>Docker: Checkpoint set at container $(docker.Actor.Attributes.name)</description>
        <group>pci_dss_10.2.7,hipaa_164.312.b,nist_800_53_AU.14,tsc_CC6.8,tsc_CC7.2,tsc_CC7.3,</group>
        <options>no_full_log</options>
    </rule>

    <rule id="87958" level="3" overwrite="yes">
        <if_sid>87900</if_sid>
